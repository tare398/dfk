...
def Tele(ccx):
  ...
  try:
    ...
    print(id)
      ...
      return '#'
  cookies = {
    'WHMCSy551iLvnhYt7': '41t5lupieojne8l80it1sgmf85',
  ...
  headers = {
    ...
    # 'cookie': 'WHMCSy551iLvnhYt7=41t5lupieojne8l80it1sgmf85; cus=joker97e%40gmail.com; __stripe_mid=cb4deb5a-78c3-490e-b5df-f18248ec8b8e6d4138; __stripe_sid=0318096e-5202-46b0-9951-deb294e7e45ff55485',
    'origin': 'https://control.king-servers.com',
    'referer': 'https://control.king-servers.com/index.php?rp=/invoice/224532/pay',
    'sec-ch-ua': '"Not_A Brand";v="99", "Google Chrome";v="109", "Chromium";v="109"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-platform': '"Windows"',
    'sec-fetch-dest': 'empty',
  ...
  data = {
    'token': '810589a1497dc822d9b2d9c36f14777c6acaf07c',
    'invoiceid': '224532',
    'ccinfo': 'new',
    'billingcontact': '0',
    'firstname': '',
